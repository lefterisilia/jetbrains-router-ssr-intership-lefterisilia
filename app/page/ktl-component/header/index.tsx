...
// Replicating the SearchResultView enum from the source
            ...
            {navItems.map((item) => (
                ...
                >
                  {item.url ? (
                      ...
                      <>
                  <span className={classNames('ktl-horizontal-menu-module_menu-item_CXDEW', {
                    'ktl-horizontal-menu-module_expanded_3GFPc': activeDropdown === item.title
                  })}>
                    {item.title}
                  </span>
