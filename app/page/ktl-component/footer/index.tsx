...
const Footer: React.FC<FooterProps> = ({ className, forwardedRef }) => {
    ...
    const navLinks = [
        ...
        { url: "https://blog.jetbrains.com/kotlin/", title: "Blog" },
        { url: "https://youtrack.jetbrains.com/issues/KT", title: "Issue Tracker" },
        { url: "https://resources.jetbrains.com/storage/products/kotlin/docs/kotlin_logos.zip", title: "Brand assets" },
        { url: "https://www.jetbrains.com/careers/jobs/?team=Kotlin", title: "Careers" }
    ];

    return (
        <footer
            className={classNames('ktl-footer-module_footer_3ENKj ktl-footer-module_footer-dark-theme_1lVqh', className)}
            ref={forwardedRef}
        >
            <div className="ktl-footer-module_social-list-area_3BpCr">
                <div className="ktl-footer-module_social-list-title_2m4tY">Stay in touch:</div>
            ...
            <nav className="ktl-footer-module_nav-list-area_11ftH">
                <ul className="ktl-nav-list-module_nav-list_2YPZ6">
                    {navLinks.map((link) => (
                        <li key={link.url} className="ktl-nav-item-module_nav-item_526AM ktl-nav-item-module_nav-item-dark-theme__ymom">
                            <a href={link.url} className="rs-link">{link.title}</a>
                        </li>
                    ))}
                </ul>
            </nav>

            <div className="ktl-footer-module_text-area_1SpnS">
                <div className="ktl-footer-module_copyright_2uBX0">
                    Kotlin™ is protected under the{' '}
                    <a className="rs-link ktl-footer-module_underlined-link_Pu1QP" href="https://kotlinlang.org/foundation/kotlin-foundation.html">
                        Kotlin Foundation
                    </a>{' '}
                    and licensed under the{' '}
                    <a
                        className="rs-link ktl-footer-module_underlined-link_Pu1QP"
                        target="_blank"
            ...
            <div className="ktl-footer-module_logo-area_24Dg6">
                <a href="https://jetbrains.com" target="_blank" rel="noreferrer" className="ktl-logo-module_link_3Bppl">
